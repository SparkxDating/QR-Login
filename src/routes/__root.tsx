  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "त्रिशक्ति सेवा फाउंडेशन एवं आर जे शंकरा आई हॉस्पिटल, वाराणसी — निःशुल्क मोतियाबिंद जाँच एवं ऑपरेशन शिविर पंजीकरण। चहनियाँ ब्लॉक में 15 सितंबर 2026 से कार्यक्रम का शुभारंभ होगा।",
      },
